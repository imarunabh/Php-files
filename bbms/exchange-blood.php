            ...
            <div id="form" style="height:450px;position:absolute;">
                <table>
                    ...
                    <tr>
                         ...
                         <td><center>
                            <?php
                            $q=$db->query("SELECT * FROM exchange_b  WHERE ebgroup='A+'");
                             echo $row=$q->rowcount();
                            ?>
                    ...
                    <tr>
                         ...
                         <td><center>
                         <?php
                            $q=$db->query("SELECT * FROM exchange_b  WHERE ebgroup='B+'");
                             echo $row=$q->rowcount();
                            ?>
                         </center></td>
                    </tr>
                    ...
                    <tr>
                         ...
                         <td><center>
                         <?php
                            $q=$db->query("SELECT * FROM exchange_b  WHERE ebgroup='AB+'");
                             echo $row=$q->rowcount();
                            ?>
                         </center></td>
                    </tr>
                    ...
                    <tr>
                         ...
                         <td><center>
                         <?php
                            $q=$db->query("SELECT * FROM exchange_b  WHERE ebgroup='O+'");
                             echo $row=$q->rowcount();
                            ?>
                         </center></td>
                    </tr>
